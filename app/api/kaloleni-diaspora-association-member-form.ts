...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const filePath = path.join(publicDir, 'kaloleni_diaspora_association_member_details.xlsx');
  ...
  try {
    ...
    const fileUrl = `https://www.birdviewmicroinsurance.com/kaloleni_diaspora_association_member_details.xlsx`;
