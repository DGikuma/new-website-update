      ...
      >
        ...
        <Providers themeProps={{ attribute: "class", defaultTheme: "dark" }}>
          <div className="flex flex-col min-h-screen relative z-10">
            ...
            {/* Footer (unchanged, just lifted above backdrop) */}
            <footer className="w-full flex flex-col items-center justify-center py-6 bg-primary text-white border-t-4 border-danger">
              <div className="max-w-7xl w-full px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      { href: "/insurance/evacuation-repatriation", label: "Evacuation & Repatriation" },
                    ].map(({ href, label }) => (
                      <Link
                        key={label}
                        href={href}
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      { href: "/insurance/medical", label: "Cookie Policy" },
                      { href: "/insurance/last-expense", label: "Privacy Policy" },
                    ].map(({ href, label }) => (
                      <Link
                        key={label}
                        href={href}
              ...
              <div className="max-w-7xl w-full px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white">
                ...
                <div className="max-w-7xl w-full px-6 py-2 flex justify-center text-sm text-white">
                  <p>
                ...
                <div className="flex items-center gap-6">
                  ...
                  {[
                    {
                      href: "https://www.facebook.com/BirdviewInsurance/", label: "Facebook", icon: (
                    ...
                    {
                      href: "https://twitter.com/BirdviewInsur", label: "Twitter", icon: (
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {
                      href: "https://www.instagram.com/birdviewinsurance/", label: "Instagram", icon: (
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {
                      href: "https://www.tiktok.com/@birdviewinsurance", label: "TikTok", icon: (
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {
                      href: "https://www.linkedin.com/company/birdviewinsurance/", label: "LinkedIn", icon: (
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {
                      href: "https://www.youtube.com/channel/...", label: "YouTube", icon: (
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      {icon}
                      <span className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 whitespace-nowrap bg-black text-white text-xs rounded px-2 py-1 opacity-0 pointer-events-none transition-opacity duration-300 group-hover:opacity-100">
                        {label}
                      </span>
                    </Link>
                  ))}
